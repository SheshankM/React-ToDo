...
function Important() {
  ...
  return (
    <div className='tasks'>
      <div className='h2'><div>Important</div></div>
      <div className="tasksWrapper">
        ...
        <form className="bottom" onSubmit={handleSubmit}>
          <input type="text" name="taskname" id="task" placeholder='Add task in list Important' value={inputvalue} onChange={handleChange} />
